...
import com.wxson.mobilecomm.codec.MediaCodecUtil;
import com.wxson.mobilecomm.preference.AppCompatPreferenceActivity;
...
public class SettingsActivity extends AppCompatPreferenceActivity {
    ...
    protected boolean isValidFragment(String fragmentName) {
        return PreferenceFragment.class.getName().equals(fragmentName)
                || CodecPreferenceFragment.class.getName().equals(fragmentName)
     ...
     */
    @TargetApi(Build.VERSION_CODES.HONEYCOMB)
    public static class CodecPreferenceFragment extends PreferenceFragment {
        @Override
        public void onCreate(Bundle savedInstanceState) {
            ...
            ListPreference listPreferenceMime = (ListPreference)findPreference("mime_list");
            CharSequence[] mimeListTitles = listPreferenceMime.getEntries();
            CharSequence[] mimeListValues = listPreferenceMime.getEntryValues();
            CharSequence[] availableMimeValues = MediaCodecUtil.getMimeList(mimeListValues);
            CharSequence[] availableMimeTitles;
            int index;
            ArrayList<CharSequence> MimeTitles = new ArrayList<>();
            for (CharSequence mimeValue : availableMimeValues){
                index = listPreferenceMime.findIndexOfValue(mimeValue.toString());
                if (index != -1){
                    MimeTitles.add(mimeListTitles[index]);
                }
            }
            availableMimeTitles = MimeTitles.toArray(new CharSequence[0]);
            listPreferenceMime.setEntries(availableMimeTitles);
